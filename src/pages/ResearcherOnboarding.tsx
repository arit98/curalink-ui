...
const ResearcherOnboarding = () => {
  ...
  useEffect(() => {
    const checkOnboarding = async () => {
      ...
      try {
        const res = await axios.get(`${API_URL}/onboarding/status`, {
  ...
  const handleContinue = async () => {
    ...
    if (step === 2) {
      try {
        const res = await researcherService.saveProfile({
          condition,
          location,
          tags: selectedTags,
        });
          ...
          <div className="bg-card rounded-2xl shadow-lg p-8 md:p-12">
            ...
            <div className="flex items-center justify-center mb-8">
              <div className="flex items-center space-x-4">
                <div className={`h-10 w-10 rounded-full flex items-center justify-center font-semibold ${step >= 1 ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"
                  }`}>1</div>
                <div className={`h-1 w-16 ${step >= 2 ? "bg-primary" : "bg-muted"}`} />
                <div className={`h-10 w-10 rounded-full flex items-center justify-center font-semibold ${step >= 2 ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"
                  }`}>2</div>
              </div>
            </div>
            ...
            {step === 1 && (
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <Label htmlFor="condition" className="text-base">Describe your research interests</Label>
                  <Textarea
                    id="condition"
                ...
                <Button onClick={handleContinue} disabled={!condition} className="w-full" size="lg">
            ...
            {step === 2 && (
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <Label htmlFor="location" className="text-base">Your location (optional)</Label>
                ...
                <div className="space-y-3">
                  <Label className="text-base">Related conditions (optional)</Label>
                ...
                <div className="flex space-x-4">
                  <Button variant="outline" onClick={() => setStep(1)} className="w-1/3" size="lg">
                    Back
                  </Button>
